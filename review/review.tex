...
\end{tikzpicture}
	...
	very small and very large cardinalities.}
	\label{fig:hll-flow}
\end{figure}
...
better estimations of higher cardinalities, so a correction for high
cardinalities is not needed anymore. With empirical bias corrections they
improve the estimation by adjusting the bias and prevent spikes.
...
\hline
	...
	LogLogBeta & 2016 & $1.04/\sqrt{m}$ & $< 6\cdot m$ & \\
	ExHLL & 2023 &  &\\ 
	HLL-TailCut & 2023 & & \\ 
\end{tabular}
\end{center}
