...
$$ 
E = \alpha_m m^2 \cdot (\sum_{i=1}^m 2^{-M[i]} )^{-1} 
$$
...
anymore the correction for large cardinalities used in HLL, is not needed
...
better estimations of higher cardinalities and empirical bias correction to
improve the estimation even more.
