...
the registerary representation of these integers, and check the longest runs of
...
shows that we get a better error for EHLL than for HLL with the same memory
usage.
...
\hline
	...
	ExHLL & 2023 & $1.0/\sqrt{m}$ & $6 \cdot m$ & using 1 additional bit below maximum per register\\ 
\end{tabular}
\end{center}
\end{table*}

Here I should have some additional remarks about
the Martingale settings that have not been discussed before.
Here I should have some additional remarks about
the Martingale settings that have not been discussed before.
Here I should have some additional remarks about
the Martingale settings that have not been discussed before.
...
balance between memory and estimation quality.
